...
```{r cuda-kernel-execution, echo=FALSE, fig.cap="Correlation between CUDA programming paradigms and hardware conventions.", fig.align='center', out.width="70%", fig.pos='H'}
